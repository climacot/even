...
interface SessionMatrixGroupProps {
  sessionName: string;
  matrices: MatrixConfig[];
}

export function SessionMatrixGroup({ sessionName, matrices }: SessionMatrixGroupProps) {
    ...
    <>
      <Card className="p-6 border-border">
        <div className="space-y-7">
          ...
          <h3 className="text-[rgb(75,85,99)] text-left tracking-[0.08px] font-bold text-[16px] not-italic mt-[0px] mr-[0px] mb-[32px] ml-[0px]">{sessionName}</h3>
          
          {/* All matrices for this session */}
          {matrices.map((matrix) => (
                              ...
                              <TooltipProvider key={colIndex}>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    ...
                                    >
                                      <span className="text-sm" style={{ color: colorStyle.color }}>
