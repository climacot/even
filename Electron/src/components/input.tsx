    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={clsx(
            isError
              ? "py-2.5 sm:py-3 px-4 block w-full border-red-500 rounded-lg sm:text-sm focus:border-red-500 focus:ring-red-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400"
